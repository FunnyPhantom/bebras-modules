...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         ...
         levelName_medium: "متوسط",
         levelName_hard: "سخت",
         warningTimeout: "<p>هشدار، بیش از {0} دقیقه است که شما در حال کار روی این فعالیت هستید. </p><p>شاید بخواهید با کلیک کردن روی دکمه در بالا سمت راست به فعالیت دیگری بروید.</p>",
         alright: "بسیار خوب",
         moveOn: "ادامه دهید",
         ...
         scoreStays: "امتیاز شما بدون تغییر می‌ماند:",
         score: "امتیاز:",
         ...
         forMorePointsMoveToNextLevel: "برای دریافت امتیاز بیشتر، به سطح سخت‌تر این وظیفه بروید.",
         ...
         lockedLevel: "این نسخه قفل شده است. حل کردن نسخه قبلی را برای نمایش این!",
         lockedLevelDev: "این نسخه معمولا قفل شده است، و نسخه قبلی باید حل شود قبل از نمایش این. با این حال، چون شما این فعالیت را محلی باز کرده اید، شما می توانید این نسخه را برای اهداف تست نمایش دهید.",
         ...
         points: "امتیازها",
         // The following messages are used when viewing tasks after contest is over
         contestOverScoreStays: "مسابقه تمام شده است، پاسخ جدید شما ذخیره نشده و امتیاز شما می ماند:",
         scoreWouldBecome: "با این پاسخ، امتیاز شما خواهد شد:",
         ...
         scoreWouldStay: "با این پاسخ، امتیاز شما همانطور می ماند:",
         ...
         difficultyWarning: "<strong>هشدار:</strong> حل کردن این نسخه زمان می برد.<br/> شما می‌توانید نسخه‌های دو یا سه ستاره‌ای از مسائل دیگر را با سرعت بیشتری حل کنید.",
   ...
   initLanguage: function() {
      if (window.stringsLanguage == undefined) {
         console.log("languageee:", `${window.stringsLanguage}`)
