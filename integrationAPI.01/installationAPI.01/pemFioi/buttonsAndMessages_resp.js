...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         ...
         levelName_medium: "متوسط",
         levelName_hard: "سخت",
         warningTimeout: "<p>هشدار، بیش از {0} دقیقه است که شما در حال کار روی این وظیفه هستید. </p><p>شاید بخواهید به وظیفه دیگری بروید، با کلیک کردن روی دکمه در بالا سمت راست.</p>",
         alright: "بسیار خوب",
         moveOn: "ادامه دهید",
         ...
         yes: "بله",
         no: "خیر",
         tryHardLevel: "پیشنهاد می کنیم که نسخه چهار ستاره را امتحان کنید.",
         tryMediumLevel: "پیشنهاد می کنیم که نسخه سه ستاره را امتحان کنید.",
         tryNextTask: "پیشنهاد می کنیم که به وظیفه بعدی بروید. اگر هنوز فرصت داشتید، بعدا برگردید و نسخه بعدی این وظیفه را امتحان کنید.",
         yourScoreIsNow: "امتیاز شما حالا:",
         worseScoreStays: "این به اندازه ی قبل خوب نیست. امتیاز شما می ماند:",
         scoreStays: "امتیاز شما همانطور می ماند:",
         score: "امتیاز:",
         noPointsForLevel: "شما هنوز هیچ امتیازی در این نسخه دریافت نکرده اید.",
         outOf: " از ",
         tryToDoBetterOrChangeTask: "سعی کنیم بهتر کنید، یا به وظیفه دیگری بروید.",
         tryToDoBetterOrMoveToNextLevel: "سعی کنید حتی بهتر کنید، یا به نسخه سخت تر بروید.",
         bestPossibleScoreCongrats: "این بهترین امتیاز ممکن در این وظیفه است، تبریک!",
         forMorePointsMoveToNextLevel: "برای دریافت امتیاز بیشتر، به نسخه سخت‌تر این وظیفه بروید.",
         youDidBetterBefore: "شما قبلا بهتر انجام داده اید.",
         scoreStays2: "امتیاز شما همانطور می ماند.",
         reloadBestAnswer: "بهترین پاسخ شما را مجددا بارگذاری کنید.",
         noAnswerSaved: "هیچ پاسخی برای این نسخه تا به حال ذخیره نشده است.",
         validate: "اعتبار سنجی",
         restart: "شروع دوباره",
         harderLevelSolved: "هشدار: شما قبلا نسخه سخت تر این وظیفه را حل کرده اید. شما قادر به دریافت امتیاز اضافی با این نسخه نخواهید بود.",
         showLevelAnyway: "به هر حال برای من نمایش بده.",
         scoreObtained: "امتیاز دریافت شده:",
