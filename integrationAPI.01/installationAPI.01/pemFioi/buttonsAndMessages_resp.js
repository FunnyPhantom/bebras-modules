...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         ...
         bestPossibleScoreCongrats: "این بهترین امتیاز ممکن در این وظیفه است، آفرین!",
         ...
         harderLevelAvailable: "توجه داشته باشید که برای این وظیفه، شما می‌توانید مستقیما روی نسخه سخت‌تر از این کار کنید.",
         lockedLevel: "این نسخه قفل شده است. حل کردن نسخه قبلی را برای نمایش این!",
         lockedLevelDev: "این نسخه معمولا قفل شده است، و نسخه قبلی باید حل شود قبل از نمایش این. با این حال، چون شما این وظیفه را محلی باز کرده اید، شما می توانید این نسخه را برای اهداف تست نمایش دهید.",
