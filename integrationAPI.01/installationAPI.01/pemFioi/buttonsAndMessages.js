...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         version: "سطح",
         levelVersionName_easy: "سطح آسان",
         levelVersionName_medium: "سطح متوسط",
         levelVersionName_hard: "سطح سخت",
         levelVersionName_easy_stars: "سطح دو ستاره",
         levelVersionName_medium_stars: "سطح سه ستاره",
         levelVersionName_hard_stars: "سطح چهار ستاره",
         levelName_easy: "آسان",
         levelName_medium: "متوسط",
         levelName_hard: "سخت",
         ...
         alright: "بسیار خوب",
         moveOn: "ادامه دهید",
         solvedMoveOn: "شما این فعالیت را کاملا حل کردید، به فعالیت دیگری بروید.",
         confirmRestart: "آیا مطمئن هستید که می خواهید این سطح را مجددا شروع کنید؟",
         yes: "بله",
         no: "خیر",
         tryHardLevel: "پیشنهاد می‌کنیم که سطح چهار ستاره را امتحان کنید.",
         ...
         reloadBestAnswer: "",//بهترین پاسختان را مجددا بارگزاری کنید بود که بیخیال خدایی معنی نداره
         noAnswerSaved: "هیچ پاسخی برای این سطح داده نشده است.",
         validate: "بررسی پاسخ",
         restart: "شروع دوباره",
         harderLevelSolved: "هشدار: شما قبلا سطح سخت‌تر این فعالیت را حل کرده اید. شما قادر به دریافت امتیاز اضافی در این سطح نخواهید بود.",
         ...
         harderLevelAvailable: "توجه داشته باشید که برای این فعالیت، شما می توانید مستقیما روی سطح  سخت‌تر از این کار کنید.",
         lockedLevel: "این سطح قفل شده است. حل کردن سطح قبلی برای نمایش این قسمت مورد نیاز است!",
         ...
         difficultyWarning: "<strong>هشدار:</strong> حل کردن این سطح زمان‌بر است.<br/> شما می‌توانید سطح‌های دو یا سه ستاره از سایر فعالیت‌ها را با سرعت بیشتری حل کنید.",
