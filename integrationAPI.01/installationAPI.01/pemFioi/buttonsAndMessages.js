...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         ...
         levelName_medium: "متوسط",
         levelName_hard: "سخت",
         warningTimeout: "<p>توجه؛ بیش از {0} دقیقه است که شما در حال کار روی این فعالیت هستید. </p><p>شاید بخواهید با استفاده از دکمۀ بازگشت به صفحه اصلی(سمت چپ بالای صفحه)، به فعالیت دیگری بروید.</p>",
         alright: "بسیار خوب",
         moveOn: "ادامه دهید",
         ...
         difficultyWarning: "<strong>هشدار:</strong> حل کردن این نسخه زمان می برد.<br/> شما به سرعت می توانید نسخه های دو یا سه ستاره ای از وظایف دیگر را حل کنید.",
