...
window.displayHelper = {
   ...
   languageStrings: {
      ...
      fa: {
         version: "نسخه",
         levelVersionName_easy: "نسخه آسان",
         levelVersionName_medium: "نسخه متوسط",
         levelVersionName_hard: "نسخه سخت",
         levelVersionName_easy_stars: "نسخه دو ستاره",
         levelVersionName_medium_stars: "نسخه سه ستاره",
         levelVersionName_hard_stars: "نسخه چهار ستاره",
         levelName_easy: "آسان",
         levelName_medium: "متوسط",
         levelName_hard: "سخت",
         warningTimeout: "<p>توجه؛ بیش از {0} دقیقه است که شما مشغول حل این فعالیت هستید. </p><p>در صورت تمایل می‌توانید با استفاده از دکمۀ بازگشت به صفحه اصلی(سمت چپ بالای صفحه)، به فعالیت دیگری بروید.</p>",
         alright: "بسیار خوب",
         moveOn: "ادامه دهید",
         solvedMoveOn: "شما این وظیفه را کاملا حل کردید، به وظیفه دیگری بروید.",
         confirmRestart: "آیا مطمئن هستید که می خواهید این نسخه را مجددا شروع کنید؟",
         yes: "بله",
         no: "خیر",
         tryHardLevel: "پیشنهاد می‌کنیم که نسخه سطح چهار ستاره را امتحان کنید.",
         tryMediumLevel: "پیشنهاد می‌کنیم که سطح سه ستاره را امتحان کنید.",
         tryNextTask: "پیشنهاد می‌کنیم که به فعالیت بعدی بروید. اگر هنوز فرصت داشتید، بعدا برگردید و سطح بعدی این فعالیت را امتحان کنید.",
         yourScoreIsNow: "امتیاز فعلی شما:",
         worseScoreStays: "این به اندازه‌ی قبل خوب نیست. امتیاز شما ثابت می‌ماند:",
         scoreStays: "امتیاز شما بدون تغییر باقی می‌ماند::",
         score: "امتیاز:",
         noPointsForLevel: "شما هنوز هیچ امتیازی در این سطح دریافت نکرده‌اید.",
         outOf: " از ",
         tryToDoBetterOrChangeTask: "تلاش کنید تا نتیجه را بهتر کنید و یا به فعالیت دیگری بروید.",
         tryToDoBetterOrMoveToNextLevel: "تلاش کنید تا نتیجه از این هم بهتر شود، یا به سطح سخت‌تر بروید.",
         bestPossibleScoreCongrats: "این بهترین امتیاز ممکن در این فعالیت است، آفرین!",
         forMorePointsMoveToNextLevel: "برای دریافت امتیاز بیشتر، به سطح سخت‌تر این فعالیت بروید.",
         youDidBetterBefore: "شما قبلا نتیجه بهتری گرفته‌اید.",
         scoreStays2: "امتیاز شما بدون تغییر می‌ماند.",
         reloadBestAnswer: "بهترین پاسختان را مجددا بارگذاری کنید.",
         noAnswerSaved: "هیچ پاسخی برای این نسخه ذخیره نشده است.",
         validate: "اعتبار سنجی",
         restart: "شروع دوباره",
         harderLevelSolved: "هشدار: شما قبلا نسخه سخت‌تر این فعالیت را حل کرده اید. شما قادر به دریافت امتیاز اضافی در این نسخه نخواهید بود.",
         showLevelAnyway: "به هر حال برای من نمایش بده.",
         scoreObtained: "امتیاز کسب شده:",
         hardVersionTakesTime: "حل کردن {0} زمان زیادی می‌برد. در نظر بگیرید که روی {1} کار کنید تا سریعا امتیاز کسب کنید.",
         illKeepThatInMind: "من در نظر خواهم گرفت.",
         harderLevelAvailable: "توجه داشته باشید که برای این فعالیت، شما می توانید مستقیما روی نسخه  سخت‌تر از این کار کنید.",
         lockedLevel: "این نسخه قفل شده است. حل کردن سطح قبلی برای نمایش این قسمت مورد نیاز است!",
         lockedLevelDev: "این نسخه معمولا قفل شده است، و نسخه قبلی باید حل شود قبل از نمایش این. با این حال، چون این فعالیت را به صورت محلی باز کرده اید، شما می توانید این نسخه را برای اهداف تست نمایش دهید.",
         gradeThisAnswer: "این پاسخ را ارزیابی کنید.",

         // The following messages are used for tasks with no feedback
         saveAnswer: "این پاسخ را ذخیره کنید",
         answerSavedModifyOrCancelIt: "پاسخ شما ذخیره شد. شما می‌توانید آن را تغییر دهید، یا {0} و دوباره شروع کنید.",
         cancelIt: "آن را لغو کنید",
         warningDifferentAnswerSaved: "هشدار: یک پاسخ متفاوت قبلا ذخیره شده است.",
         youMay: "شما می‌توانید {0}.",
         reloadIt: "آن را مجددا بارگذاری کنید",
         saveThisNewAnswer: "این پاسخ جدید را ذخیره کنید",

         gradingInProgress: "در حال ارزیابی",
         scoreIs: "امتیاز شما:",
         point: "امتیاز",
         points: "امتیازها",
         // The following messages are used when viewing tasks after contest is over
         contestOverScoreStays: "مسابقه تمام شده است، پاسخ جدید شما ذخیره نشده و امتیاز شما بدون تغییر می‌ماند:",
         scoreWouldBecome: "با با این پاسخ، امتیاز شما برابر خواهد شد:",
         reloadValidAnswer: "پاسخ معتبر را مجددا بارگذاری کنید.",
         contestOverAnswerNotSaved: "مسابقه تمام شده است، پاسخ جدید شما ذخیره نشده است.",
         scoreWouldStay: "با این پاسخ، امتیاز شما بدون تغییر می‌ماند:",
         answerNotSavedContestOver: "مسابقه تمام شده است، پاسخ شما ذخیره نشده است. شما می‌توانید {0}.",
         reloadSubmittedAnswer: "پاسخ تایید شده را مجددا بارگذاری کنید",
         difficultyWarning: "<strong>هشدار:</strong> حل کردن این نسخه نیازمند زمان قابل توجهی است.<br/> شما می‌توانید نسخه‌های دو یا سه ستاره از سایر فعالیت‌ها را با سرعت بیشتری حل کنید.",
         enemyWarning: "<strong>هشدار:</strong> در این چالش، رایانه مطمئن خواهد شد که شما راه حل را تصادفی پیدا نکنید."
      },
   },
