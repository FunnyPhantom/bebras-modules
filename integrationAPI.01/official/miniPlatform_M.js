         ...
         'header' : '\
            <div id="main_header" style="width:100%; border-bottom:1px solid #B47238;overflow:hidden">\
               <table style="width:100%;margin: 10px auto;">\
                  ...
                  <td><a href="https://soal.learn-python.ir/" style="display:inline-block;text-align:right;">صفحه اصلی</a></td>\
               </table>\
            </div>'
      },
      laptop: { 
         'header' : '\
            <div id="main_header" style="width:100%; border-bottom:1px solid #B47238;overflow:hidden">\
               <table style="width:770px;margin: 10px auto;">\
                  ...
                  <td><span style="font-size:32px;">یادگیری پایتون</span></td>\
                  <td><a href="http://soal.learn-python.ir/" style="display:inline-block;text-align:right;">صفحه اصلی</a></td>\
               </table>\
            </div>'
      },
      none: {
